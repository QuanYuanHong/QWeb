...
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2017/4/26 11:11:45   N/A    初版
*
...
namespace Book.DAL
{
	...
	public partial class DalT_Stock_InHead
	{
		...
		public int Add(Book.Model.T_Stock_InHead model)
		{
			...
			strSql.Append("CreateTime,ProviderId,Creater)");
		...
		public Book.Model.T_Stock_InHead GetModel(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,CreateTime,ProviderId,Creater from T_Stock_InHead ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,CreateTime,ProviderId,Creater ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,CreateTime,ProviderId,Creater ");
			strSql.Append(" FROM T_Stock_InHead ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
