...
namespace Book.DAL
{
	...
	public partial class DalT_Stock_OutHead
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "T_Stock_OutHead"); 
		}
		...
		public int Add(Book.Model.T_Stock_OutHead model)
		{
			...
			strSql.Append("CreateTime,CustomerId,Creater)");
		...
		public Book.Model.T_Stock_OutHead GetModel(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,CreateTime,CustomerId,Creater from T_Stock_OutHead ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,CreateTime,CustomerId,Creater ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,CreateTime,CustomerId,Creater ");
			strSql.Append(" FROM T_Stock_OutHead ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
